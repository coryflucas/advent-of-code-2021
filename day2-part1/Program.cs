...
Position Forward(Position current, int amount) => new Position(current.Horizontal + amount, current.Depth);
Position Up(Position current, int amount) => new Position(current.Horizontal, current.Depth - amount);
Position Down(Position current, int amount) => new Position(current.Horizontal, current.Depth + amount);
